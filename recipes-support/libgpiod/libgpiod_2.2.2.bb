...
# backport of https://github.com/openembedded/openembedded-core/commit/81fd917ac05be19d8345fff272a2ffc17a257880
...
GROUPADD_PARAM:${PN}-manager = "--system em-group-gpio"
USERADD_PARAM:${PN}-manager = "--system -M -s /bin/nologin -g em-group-gpio gpio-manager"
...
do_install:append() {
    # removed 90-gpio.rules as we have our own ruleset for /dev/gpiochip*
    rm -f ${D}${nonarch_base_libdir}/udev/rules.d/90-gpio.rules
